...
\printbibliography[keyword=chapter2, heading=subbibliography, title={References for Chapter 2}]
\printbibliography[keyword=chapter3, heading=subbibliography, title={References for Chapter 3}]
\printbibliography[keyword=chapter4, heading=subbibliography, title={References for Chapter 4}]
\printbibliography[keyword=chapter5, heading=subbibliography, title={References for Chapter 5}]
\printbibliography[keyword=chapter6, heading=subbibliography, title={References for Chapter 6}]
