...
\begin{itemize}
    \item Custom C++ Middleware: creating a specialized Niagara Data Interface (NDI) to map ECS memory chunks to Niagara parameters
    \item Manual Lifecycle Management: Synchronizing the birth and death of Mass entities with the spawning and reaping of Niagara particles
    \item Shader Complexity: Re-implementing the VAT (Vertex Animation Texture) logic within the Niagara material graph to ensure visual consistency with the HISM-based agents
\end{itemize}
