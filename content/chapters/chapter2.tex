...
In the proprietary space, Saber Interactive's Swarm Engine represents a specialized application of ECS. Developed to power the massive NPC counts in \textit{World War Z} and later utilized for the Tyranid hordes in \textit{Warhammer 40,000: Space Marine 2}, the engine utilizes ECS to manage thousands of autonomous agents simultaneously. By utilizing a custom architecture that prioritizes high-throughput data processing over traditional object-oriented hierarchies, the engine facilitates complex collective behaviors.
...
The efficacy of these architectures is best observed in titles where the simulation complexity is the primary gameplay driver. Beyond \textit{World War Z}, games such as \textit{Cities: Skylines II} leverage ECS to track the individual economic and navigational states of tens of thousands of citizens in real-time.\cite{CitiesSkylineIIUnite} 
