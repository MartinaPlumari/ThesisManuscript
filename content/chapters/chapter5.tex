...
\begin{figure}[h]
\centering
\includegraphics[width=1\textwidth]{images/StateTreeEditor.png}
\caption{An example of StateTree editor visualization.}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.8\textwidth]{images/TasksExample.png}
\caption{When clicking on a State it is possible to add and configure Tasks in this section of the detail panel.}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[width=1\textwidth]{images/StateTreeEvaluatorExample.png}
\caption{A simple evaluator defined in Blueprint that returns the current location of the player.}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[width=1\textwidth]{images/TransitionExample.png}
\caption{Example of transition definition. The next state in this case will be different based on the state outcome.}
\end{figure}
...
A clear implementation of this pattern can be found in the \newline\texttt{FMassClaimSmartObjectTask}:
